...
| Key            | Default                                 | Effect                                                                                                                                       |
| -------------- | --------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------- |
| `readonlyMode` | off                                     | `true` puts the Applications section in managed mode: it lists what is installed and offers nothing that changes it. Any other value is off. |
