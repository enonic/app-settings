package com.enonic.xp.app.settings.lib.webapp;
    ...
    implements ScriptBean
{
    ...
    {
        // Existence only. app-applications goes on to execute the controller and check for exported
        // get/post/head/all — running another application's top-level code every time an admin opens
        // the panel, which is a steep price for catching a webapp.js that exports nothing.
