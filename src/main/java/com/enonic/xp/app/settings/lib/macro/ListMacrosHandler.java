package com.enonic.xp.app.settings.lib.macro;
    ...
    implements ScriptBean
{
    ...
    {
        // getByApplication, not getByApplications( application, SYSTEM ): app-applications sends the
        // system macros along with every application's own and then drops them again client-side.
