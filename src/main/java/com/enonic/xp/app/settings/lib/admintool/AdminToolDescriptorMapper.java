package com.enonic.xp.app.settings.lib.admintool;
    ...
    implements MapSerializable
{
    ...
    {
        // No url: app-applications assembles /admin/<app>/<name> from the servlet request, but
        // lib-admin's getToolUrl already answers that, so the wrapper builds it in TypeScript.
        ...
        // TODO: [#8] Unused until displayName is localized against the target app's i18n bundle.
