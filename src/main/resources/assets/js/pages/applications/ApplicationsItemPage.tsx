...
export function ApplicationsItemPage() {
   ...
   * ! list has not arrived — "select an item" there reads as a deep link that did nothing. A list
   * ! that failed says so, and a key nothing answers to is an application that is gone, not an empty
   * ! selection.
   */
  if (application == null) {
