...
/**
 * How many rows each bucket holds, counted over whatever it is given — the search result, so the
 * numbers on the buttons narrow with the search rather than reporting the whole catalogue.
 */
