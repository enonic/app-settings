...
/**
 * Forgets what an application provides — its descriptors change when it is started, stopped,
 * updated or uninstalled.
 *
 * A panel that is open on the application reloads at once, because `useApplicationInfo` asks again
 * for an entry that went missing under it; anything else loads on its next visit.
 */
