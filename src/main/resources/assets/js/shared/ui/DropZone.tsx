...
export type DropZoneProps = {
  ...
  hint?: ReactNode;
  /**
   * What the file picker offers. Dropped files are not filtered against it — Content Studio's zone
   * discards them silently, where the caller can say what it would not take.
   */
  accept?: string;
  multiple?: boolean;
...
/**
 * A box to click or drop files onto. Content Studio v6's `shared/ui/DropZone.tsx` is the same
 * component; keep the two portable.
 */
